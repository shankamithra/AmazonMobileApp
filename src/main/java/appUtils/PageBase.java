...
public class PageBase {
    ...
    public static String appiumURL = null;
    ...
    public static  AndroidDriver<AndroidElement> capabilities(String appName) throws IOException, InterruptedException
    {
       ...
       File app = new File(appDir, "Amazon_shopping.apk");
        ...
        cap.setCapability(MobileCapabilityType.DEVICE_NAME,"NewEmulator");
        cap.setCapability(MobileCapabilityType.APP , app.getAbsolutePath());
        //cap.setCapability(MobileCapabilityType.AUTOMATION_NAME,"uiautomator2")

        Reporter.log("Launching android driver...",true);
        driver = new AndroidDriver(new URL(appiumURL), cap);
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        Reporter.log("Connection established successfully",true);
    ...
    public void sleepSome(int i) throws InterruptedException {
        Thread.sleep(i);
    }
